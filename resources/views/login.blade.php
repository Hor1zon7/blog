        ...
        <form action="{{'dologin'}}" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <input class="input-text size-L" type="text" placeholder="验证码" name="yzm">
                    <img src="{{ captcha_src() }}" id="yzmimg">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <button type="submit" class="btn btn-success radius size-L" id="login">&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;</button>
...
<div class="footer">Copyright 七海辣辣米 by H-ui.admin v3.1</div>
...
<script>
    $("#kanbuq").click(function () {
        $("#yzmimg").prop('src', "{{captcha_src()}}" + Math.random());
    });
